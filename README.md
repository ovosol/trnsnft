...
This app uses video autoplay. Autoplay is disabled by default on most browsers. To enable autoplay, you must enable it
in your browser settings.

Chrome:

1. Open `chrome://settings/content/sound` in your browser
2. Add the frontend ip address to the allow list
  
## Build Setup

Create .env file in root directory and add your environment variables according to `example.env`
